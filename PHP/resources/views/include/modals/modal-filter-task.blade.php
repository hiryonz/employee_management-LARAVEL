                ...
                <div class="modal fade" id="filter-{{$type}}" tabindex="-1" role="dialog" aria-labelledby="{{$type}}Label" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('guardar.filtro')}}" method="POST">
                                @csrf
                                <div class="modal-body">
                                    <input type="hidden" name="type" value="{{$type}}">
                                    @if ($type === 'departamento')
                                        <select class="form-control" id="filter-departamento-input" name="filter-input">
                                        ...
                                        @elseif ($type === 'fecha')
                                            <input type="date" id="filter-fecha-input" class="form-control" name="filter-input">
                                            <div class="mt-2">
                                        ...
                                        @elseif ($type === 'prioridad')
                                            <select id="filter-prioridad-input" class="form-control" name="filter-input">
